...
const ProjectCard: FunctionComponent<{
	...
	return (
		<div>
			...
			{showDetail === id && (
				<div className='grid rounded-lg md:grid-cols-2 absolute top-0 left-0 z-10 h-auto w-full gap-x-12 text-black bg-gray-100 dark:text-white dark:bg-dark-100 p-2 md:p-10'>
