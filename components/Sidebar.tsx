...
const Sidebar = () => {
	...
	return (
		<Fragment>
			...
			<h1 className='font-kaushan pointer-events-none my-4 select-none text-3xl font-medium tracking-wider print:my-0'>
				<span>#Bekhzod</span>
				<span>_x64</span>
			</h1>
			<p className='dark:bg-dark-200 pointer-events-none my-3 select-none rounded-full bg-slate-200 px-2 py-1 print:my-2'>
				Веб разработчик
			</p>
			<a
				href='#'
			...
			<div className='text-green mx-auto my-5 flex w-9/12 items-center justify-around print:hidden md:w-full'>
				<a
